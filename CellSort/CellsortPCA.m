...
[fpath, fname] = fileparts(fn);%Tb added fpath was [~,
...
% Create covariance matrix different to version 1
if nt < npix 
...
if nt < npix 
    ...
    [mixedsig, CovEvals, percentvar] = cellsort_svd(covmat, nPCs, nt, npix);% added percentvar TB
    ...
    [mixedfilters, CovEvals, percentvar] = cellsort_svd(covmat, nPCs, nt, npix);%added percentvar TB
    mixedfilters = mixedfilters' * npix;
    
    % Load the other set of principal components
    [mixedsig] = reload_moviedata(nt, mov', mixedfilters', CovEvals);% removed ' after mixedfilters TB
